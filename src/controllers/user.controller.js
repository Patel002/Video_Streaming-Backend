...
import { uploadOnCloudinary, oldImageDelete as deleteOldImage } from "../utils/cloudinary.js";
...
const getCurrentUser = asyncHandler(async(req, res) => {
  return res.status(200).json(new ApiResponse(200, req.user, "current user fetched succssfully"))
}) 
